...
uses
  Classes, SysUtils, godata2,goCore2,goEval2,process2,
  mind1;
...
writeln(fpOut);
writeln(fpOut,'====================================');
writeln(fpOut,' =  GO/ITS 1 Report 1 - (C) 1986-2019 by Diana Kanecki, DM(ABD), MBA, ACS, Bio. Sci., All Rights Reserved');
writeln(fpOut,'====================================');
