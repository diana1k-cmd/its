//====================================================
// Updated 2019 for Lazarus 2.0.2
//====================================================
// ===================================================
...
wait;
    ...
    on E: EInOutError do
      writeln('M1(100) File handling error occurred. Details: ', E.ClassName, '/', E.Message);
  end;
...
wait;
    ...
    // If there was an error the reason can be found here
    on E: EInOutError do
      writeln('M1(120) File handling error occurred. Details: ', E.ClassName, '/', E.Message);
  end;
...
//readln;
    ...
    // If there was an error the reason can be found here
    on E: EInOutError do
      writeln('M1(200) File handling error occurred. Details: ', E.ClassName, '/', E.Message);
  end;
end;
...
//readln;
    ...
    // If there was an error the reason can be found here
    on E: EInOutError do
      writeln('M1(210) File handling error occurred. Details: ', E.ClassName, '/', E.Message);
  end;
end;
...
//readln;
    ...
    // If there was an error the reason can be found here
    on E: EInOutError do
      writeln('M1(230) File handling error occurred. Details: ', E.ClassName, '/', E.Message);
  end;
end;
...
//readln;
    ...
    // If there was an error the reason can be found here
    on E: EInOutError do
      writeln('M1(240) File handling error occurred. Details: ', E.ClassName, '/', E.Message);
  end;
end;
...
writeln2(2,'*** CLOSING OUTPUT FILES ***');
    ...
    // If there was an error the reason can be found here
    on E: EInOutError do
      writeln('M1(300) File handling error occurred. Details: ', E.ClassName, '/', E.Message);
  end;
